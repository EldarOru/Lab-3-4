...
public abstract class Trolls {
    ...
    public ArrayList<Thing> Inventory = new ArrayList<>();
    ...
    public void openChest (Thing thing) throws CheckException{//срочно нужно исключение, мне и моему другу тоже
        ...
        if (Inventory.get(i).name == "топор" & Inventory.size() != 0 ){
            ...
            PreciousStones.Diamond diamond = new PreciousStones.Diamond("алмаз");
            PreciousStones.Ruby ruby = new PreciousStones.Ruby("рубин");
            PreciousStones.Emerald emerald = new PreciousStones.Emerald("изумруд");
